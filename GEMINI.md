Appwrite now uses a relational tablesdb structure, not the collections structure we are used to. Please ensure all appwrite database interactions use the tables api.
Appwrite
