...
export const PLANS = {
  spark: {
    ...
    name: "Spark",
    price: 8.99,
    stripeProductId: "prod_UOVDrpmMNY2lnH",
    stripePriceId: "price_1TPiDERvtyb22gqJ5bbi49BH",
    voltzPerMonth: 300,
  ...
  zenith: {
    ...
    name: "Zenith",
    price: 19.99,
    stripeProductId: "prod_UOVEDbbaBZtjcU",
    stripePriceId: "price_1TPiEURvtyb22gqJPePFVbsg",
    voltzPerMonth: 1000,
