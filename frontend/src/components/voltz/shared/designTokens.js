...
export const PLANS = {
  spark: {
    ...
    name: "Spark",
    price: 8.99,
    stripeProductId: "prod_UQNgQ6JzRAxiVu",
    stripePriceId: "price_1TRWvQRoYUlSaKsayRC9l1SY",
    voltzPerMonth: 300,
  ...
  zenith: {
    ...
    name: "Zenith",
    price: 19.99,
    stripeProductId: "prod_UQNg1fg0EN3Do6",
    stripePriceId: "price_1TRWvURoYUlSaKsaTQkXWFS9",
    voltzPerMonth: 1000,
